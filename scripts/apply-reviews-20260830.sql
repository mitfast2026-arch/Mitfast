-- ===========================================================================
-- MITFAST PRODUCT REVIEWS & 5-STAR RATINGS MIGRATION
...
-- 2. Helper function to check if a customer has a qualifying RFQ or Order for a product
...
-- 3. Atomic review upsert RPC (enforces eligibility, validation, and single row per customer-product)
...
DROP POLICY IF EXISTS "product_reviews_update_customer" ON public.product_reviews;
...
DROP POLICY IF EXISTS "product_reviews_delete_customer_or_admin" ON public.product_reviews;
