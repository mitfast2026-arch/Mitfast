  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4 space-y-6">
      <div className="saas-panel p-8 text-center space-y-4">
        <div className="w-12 h-12 rounded-2xl bg-cyan-500/10 text-cyan-600 flex items-center justify-center mx-auto">
          <ShieldCheck className="w-6 h-6" />
        </div>
        <h1 className="type-page">RFQs & Pricing Handled by Admin</h1>
        <p className="type-subtitle max-w-lg mx-auto">
          Customer RFQs, volume pricing, and negotiations are coordinated centrally by MITFAST Admin.
