                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="type-id text-[#111315]">{r.rfq_number}</span>
                      <span className={
                        r.status === 'accepted' 
                          ? 'saas-badge-success' 
                    ...
                    <div className="flex items-center justify-between text-xs pt-2 border-t border-[#E2E4E8]">
                      <span className="text-[#6B7280]">{r.items?.length || 0} component line(s)</span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E2E4E8] pb-4">
                ...
                {canAct && (
                  <div className="flex flex-wrap gap-2 self-start sm:self-auto shrink-0">
                    ...
                    >
                      <MessageSquare className="w-3.5 h-3.5 text-[#111315]" />
                      ...
                      {selectedRfq.items?.map((item: any) => {
                        return (
                          <tr key={item.id}>
                            ...
                            <td className="text-right text-[#111315] type-metric">{item.original_quantity} Units</td>
                            {canAct && (
