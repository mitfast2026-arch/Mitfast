...
- Never use `mithronadmin@gmail.com` or its Supabase/Vercel accounts for MITFAST — only `qubphaacuuwlpdrsprjl` + `mitfast2026-arch/Mitfast` + `mitfast-b2b.vercel.app`.
